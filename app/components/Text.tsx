...
const $sizeStyles = {
  ...
  xl: { fontSize: 32, lineHeight: 40 } satisfies TextStyle,
  lg: { fontSize: 28, lineHeight: 36 } satisfies TextStyle,
...
const $presets = {
  ...
  heading: [$baseStyle, $sizeStyles.lg, $fontWeightStyles.bold] as StyleProp<TextStyle>,
